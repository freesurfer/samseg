...
setup(
    ...
    license='GPL3',
    packages=["samseg", "samseg.subregions", "samseg.gems", "samseg.cli", "samseg.atlas", "samseg.atlas.Lesion_Components",
              "samseg.atlas.Lesion_Components.MS", "samseg.atlas.Lesion_Components.Leuko",
              "samseg.atlas.Lesion_Components.MS.VAE", "samseg.atlas.Lesion_Components.Leuko.VAE"],
